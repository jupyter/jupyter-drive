...
export declare var drive_utils: {
    FOLDER_MIME_TYPE: string;
    NOTEBOOK_MIMETYPE: string;
    FileType: {
        FILE: number;
        FOLDER: number;
    };
    split_path: (path: any) => any;
    get_id_for_path: (path: any, type: any) => any;
    get_resource_for_relative_path: (path_component: any, type: any, opt_child_resource: any, folder_id: any) => any;
    get_resource_for_path: (path: any, type: any) => any;
    get_new_filename: (opt_folderId: any, ext: any, base_name: any) => any;
    upload_to_drive: (data: any, metadata: any, opt_fileId: any, opt_params: any) => any;
    get_contents: (resource: any, already_picked: any, opt_num_tries: any) => any;
    set_user_info: (selector: any) => any;
};
