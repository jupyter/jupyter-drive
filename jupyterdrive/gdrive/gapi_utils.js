...
define(["require", "exports", 'jquery', 'base/js/dialog', 'base/js/utils'], function (require, exports, $, dialog, utils) {
    ...
    (function (gapi_utils) {
         ...
         * @type {string}
         */
        gapi_utils.APP_ID = '763546234320';
        /**
         ...
         *     with an Error.
         */
        gapi_utils.download = function (url) {
         ...
         */
        gapi_utils.execute = function (request) {
         ...
         **/
        gapi_utils.config = function (conf) {
        ...
        gapi_utils.gapi_ready = Promise.all([load_gapi, _conf_prm]).then(function (values) {
            var config = values[1];
            return authorize(null, config);
        });
    })(gapi_utils = exports.gapi_utils || (exports.gapi_utils = {}));
});
