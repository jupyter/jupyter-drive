...
define(["require", "exports", './gapi_utils'], function (require, exports, gapi_utils) {
    var picker_utils;
    (function (picker_utils) {
        /**
         ...
         *     they cancel.
         */
        picker_utils.pick_file = function (parent_id, filename) {
            return new Promise(function (resolve, reject) {
                ...
                var picker = builder.addView(search_view).setOAuthToken(gapi.auth.getToken()['access_token']).setAppId(gapi_utils.gapi_utils.APP_ID).setCallback(callback).build();
                picker.setVisible(true);
            });
        };
    })(picker_utils = exports.picker_utils || (exports.picker_utils = {}));
});
